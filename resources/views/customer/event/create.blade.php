        ...
        <div class="col-12 p-0">
            <div aria-label="breadcrumb" class="breadcrumb-wrapper">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a
                            href="{{ route('customer.create.event') }}">Create</a></li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('customer.store.event') }}" method="POST"
        ...
        <div class="row clearfix">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                <div class="card card-event-new">
                    <div class="body">
                        @include('layouts.alert')
                        <form action="{{ route('customer.store.event') }}" method="post" enctype="multipart/form-data"
                            class="form-event">
                            @csrf
                            <div class="row clearfix">
