...
@section('content')
        ...
        <section class="events">
            <div class="tab-events d-flex justify-content-between align-items-center">
                <ul class="nav nav-pills mb-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('customer.edit.event.text', ['invoice' => $event->order->invoice]) }}">
                    ...
                    @if (
                        ...
                        <li class="nav-item">
                            <a href="{{ route('customer.edit.event.photos', ['invoice' => $event->order->invoice]) }}">
                    ...
                    @endif
                    <li class="nav-item">
                        <a href="{{ route('customer.edit.event.guestbooks', ['invoice' => $event->order->invoice]) }}">
                    ...
                    @if (
                        ...
                        <li class="nav-item">
                            <a
                                href="{{ route('customer.edit.event.templatemessage', ['invoice' => $event->order->invoice]) }}">
                                <span class="iconify" data-icon="entypo:new-message"></span>
                                Template Message
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('customer.edit.event.sendlink', ['invoice' => $event->order->invoice]) }}">
                                <span class="iconify" data-icon="tabler:message-check"></span>
                                Send Invitation Link
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('customer.edit.event.angpao', ['invoice' => $event->order->invoice]) }}">
                    ...
                    @endif
                    <li class="nav-item">
                        <a href="{{ route('customer.edit.event.greetings', ['invoice' => $event->order->invoice]) }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <!-- <select class="form-select" data-control="select2" name="type"
                                    data-placeholder="Select an option" id="exporttype">
                                    <option value="0" selected>--Pilih Jenis Hasil Eksport--</option>
                                    <option value="1">Berdasarkan status pinjam</option>
                                    <option value="2">Berdasarkan jenis kelamin</option>
                                    <option value="3">Berdasarkan Kategori/Sub-Kategori</option>
                                </select> -->
                            <!-- <select class="form-select" id="list_bank" name="list_banks">
    ...
    @endforeach
                            ...
                            <!-- <input class="form-control d-none" type="text" name="nama_bank"> -->
                        </div>
                        <div class="form-group">
...
@section('add-js')
    ...
    <script>
        ...
        $('#btn_text_section_quote_save').on('click', function(e) {
            ...
            console.log(message);
            $.ajax({
                url: "{{ route('textSection.quote.store') }}",
                type: "post",
                headers: {
        ...
        $('#btn_text_section_title_save').on('click', function(e) {
            ...
            $.ajax({
                url: "{{ route('textSection.title.store') }}",
                type: "post",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
        ...
        $('#btn_template_message_save').on('click', function(e) {
            ...
            $.ajax({
                url: "{{ route('template.message.store') }}",
                type: "post",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
