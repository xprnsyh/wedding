            ...
            <div aria-label="breadcrumb" class="breadcrumb-wrapper">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a
                            href="{{ route('customer.list.order') }}">Order</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a
                            href="{{ route('customer.create.order') }}">Create</a></li>
                </ol>
            </div>
        </div>
    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Please fill here..."
                                                disabled="disabled"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="customer_address" class="form-control no-resize" id="" rows="3"
                                                placeholder="Please fill here..."
                                                no-resize>{{ old('customer_address') ? old('customer_address') : $user->customer_address }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                                ...
                                                <div class="card-body card-price text-center {{ old('product') == $product->id ? 'active' : false }}"
                                                    ...
                                                    @if($product->discount()->where('is_active',true)->count() > 0)
                                                        @if($product->discount->discount_type == 'Presentase')
                                                            ...
                                                            <p>RP {{number_format($harga_akhir)}}</p>
                                                        @else
                                                            <?php
                                                                $harga_awal = $product->price;
                                                                $discount = $product->discount->amount;
        ...
        <div class="row clearfix">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                <div class="card card-order-new">
                    <div class="body">
                        @include('layouts.alert')
                        <form action="{{ route('customer.store.order') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row clearfix">
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="customer_address" id="address" cols="30" rows="3"
                                                    ...
                                                    style="height: 100px">{{ old('customer_address') ? old('customer_address') : $user->address }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group">
