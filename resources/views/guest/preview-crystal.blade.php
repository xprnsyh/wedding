...
<body>
        ...
        <div class="row valign">
            <div class="col s12">
                <div class="template">
                    ...
                    <p style="font-style:italic;">{{ \Carbon\Carbon::parse($event->tanggal_ijab)->format('d M Y')}}</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="col s12 m12 l12">
                        <div class="opening-detail">
                            <div class="row">
                                ...
                                <div class="col s12 m4 l2">
                                    <h4 class="chocolate-text-light">{{$event->nama_lengkap_mempelai_wanita}}</h4>
                                    <p class="white-text">{{$event->bio_mempelai_wanita}}</p>
                                </div>
                                <div class="col s12 m4 l4">
                                    <h4 class="chocolate-text-light">&</h4>
                                </div>
                                <div class="col s12 m4 l2">
                                    <h4 class="chocolate-text-light">{{$event->nama_lengkap_mempelai_pria}}</h4>
                                    <p class="white-text">{{$event->bio_mempelai_pria}}</p>
                                </div>
                                <div class="col s12 m4 l2">
                    ...
                    <div class="row">
                        <div class="col s12 m12">
                            <div class="opening-detail" id="btn-lokasi">
                                <a href="{!!$event->gm_ijab!!}" class="btn-choco-light">Lihat Lokasi</a>
                            </div>
                        </div>
                    </div>
                    @endif
    ...
    <div class="section blue valign-wrapper" style="padding:0;">
        <div class="row valign">
            <div class="col s12 m12 l12">
                <div class="row">
                        ...
                        <div class="attend">
                            <div class="row">
                                <form action="{{route('attending',[ 'id' => $event->id])}}" autocomplete="off" method="POST">
                                    ...
                                    <div class="col s12 m12 l4">
                                        <button type="submit" class="btn btn-choco-light waves-effect">I am Attending</button>
                                    </div>
                                </form>
                            </div>
                        </div>
