...
<head>
    ...
    <title>Hoofey - Template Wedding Crystal</title>
...
<body>
    <div class="section header" style="padding-bottom:0;">
        <div class="background">
            <img src="{{asset('admin-bsb/images/image-1.png')}}" style="opacity:0.7;">
        </div>
        <div class="row valign">
            <div class="col s12">
                <div class="template">
                    ...
                    <p style="font-style:italic;">01-01-2021</p>
                </div>
            </div>        
        </div>
        <div style="height: 150px; overflow: hidden;" >
            <svg viewBox="0 0 500 150" preserveAspectRatio="none" style="height: 100%; width: 100%;">
                <path d="M-3.10,20.22 C149.99,150.00 434.25,162.33 509.87,26.14 L500.00,150.00 L0.00,150.00 Z" style="stroke: none; fill: #b49173;"></path>
                <path d="M-4.79,79.44 C149.99,150.00 434.25,162.33 514.39,40.95 L500.00,150.00 L0.00,150.00 Z" style="stroke: none; fill: #313d4d;"></path>
            </svg>
        </div>
    </div>

    <div class="section blue valign-wrapper">
        <div class="row valign">
                    ...
                    <div class="col s12 m12 l12">
                        <div class="opening-detail">
                            <div class="row">
                                ...
                                <div class="col s12 m4 l2">
                                    <h4 class="chocolate-text-light">Adam</h4>
                                    <p class="white-text">Putra dari Bapak Rully Wijaya & Ibu Dina Dayani</p>
                                </div>
                                <div class="col s12 m4 l4">
                                    <h4 class="chocolate-text-light">&</h4>
                                </div>
                                <div class="col s12 m4 l2">
                                    <h4 class="chocolate-text-light">Hawa</h4>
                                    <p class="white-text">Putri dari Bapak Wijaya & Ibu Agustine</p>
                                </div>
                                <div class="col s12 m4 l2">
    ...
    <div class="section chocolate-light valign-wrapper">
        <div class="row valign">
            <div class="col s12 m12 l12">
                <div class="row">
                    <div class="col s12 m12 l8" id="lokasi-container">
                            <div class="opening-detail">
                                <div class="col s12 m12 l6">
                                    ...
                                    <p class="white-text">Senin, 1 Januari 2021</p>
                                    <p class="white-text">10:00 WIB</p>
                                    <p class="white-text">Jalan Raya Kedawung</p>
                                    <p class="white-text">Cirebon</p>
                                </div>
                                <div class="col s12 m12 l6">
                    ...
                    <div class="row">
                        <div class="col s12 m12">
                            <div class="opening-detail" id="btn-lokasi">
                                <a href="#" class="btn-choco-light">Lihat Lokasi</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="section blue valign-wrapper">
        <div class="row valign">
            <div class="col s12 m12 l12">
                ...
                <div class="row">
                    <div class="col s12 m12 l8" id="countdown-container-transparent">
                        <div class="countdown">
                            <div class="row">
                                <div class="col s12">
                                    <ul>
    ...
    <div class="section blue" id="slider-gallery">
    ...
    <div class="section blue valign-wrapper">
        <div class="row valign">
            <div class="col s12 m12 l12">
                ...
                <div class="row">
                    <div class="col s12 m12 l10 chocolate-light" id="attend-input-container">
                        <div class="attend">
                            <div class="row">
                                <form action="#">
                                    <div class="col s12 m12 l4">
                                        <label for="name" class="white-text">Your Name</label>
                                        <input type="text" name="name" class="input-white" placeholder="Your name">
                                    </div>
                                    <div class="col s12 m12 l4">
                                        <label for="email" class="white-text">Your Email Address</label>
                                        <input type="email" name="email" class="input-white" placeholder="Your email address">
                                    </div>
                                    <div class="col s12 m12 l4">
                                        <button type="submit" class="btn btn-choco-light waves-effect">Send</button>
                                    </div>
                                </form>
                            </div>
                        </div>
