...
<head>
    ...
    <title>Hoofey - Template Wedding Grey</title>
...
<body>
    <div class="section header" style="padding-bottom:0;">
        ...
        <div style="height: 150px; overflow: hidden;" >
            <svg viewBox="0 0 500 150" preserveAspectRatio="none" style="height: 100%; width: 100%;">
                <path d="M-43.73,-24.17 C284.71,157.39 466.42,173.19 512.13,-8.38 L553.33,173.19 L0.00,150.00 Z" style="stroke: none; fill: #c4c4c4;"></path>
                <path d="M-16.64,26.14 C284.71,157.39 495.77,213.64 512.13,-8.38 L553.33,173.19 L0.00,150.00 Z" style="stroke: none; fill: #474747;"></path>
            </svg>
        </div>
    </div>

    <div class="section grey darken-3 valign-wrapper">
        <div class="row valign">
                    ...
                    <div class="col s12 m12 l12">
                        <div class="opening-detail">
                            <div class="row">
                                ...
                                <div class="col s12 m4 l2">
                                    <h4 class="grey-text text-lighten-1">Adam</h4>
                                    <p class="white-text">Putra dari Bapak Rully Wijaya & Ibu Dina Dayani</p>
                                </div>
                                <div class="col s12 m4 l4">
                                    <h4 class="grey-text text-lighten-1">&</h4>
                                </div>
                                <div class="col s12 m4 l2">
                                    <h4 class="grey-text text-lighten-1">Hawa</h4>
    ...
    <div class="section grey darken-3 valign-wrapper">
        <div class="background">
            <img src="{{asset('admin-bsb/images/image-5.png')}}" style="opacity:0.4;">
        </div>
        <div class="row valign">
            <div class="col s12 m12 l12">
                <div class="row valign">
                    ...
                    <div class="row">
                        <div class="col s12 m12">
                            <div class="opening-detail" id="btn-lokasi">
                                <a href="#" class="btn-transparent">Lihat Lokasi</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="section grey darken-3" id="slider-gallery">
    ...
    <div class="section grey darken-3 valign-wrapper">
        <div class="row valign">
            <div class="col s12 m12 l12">
                ...
                <div class="row">
                    <div class="col s12 m12 l10 grey lighten-1" id="attend-input-container">
                        <div class="attend">
                            <div class="row">
                                <form action="#" method="post">
                                    <div class="col s12 m12 l4">
                                        <label for="name" class="white-text">Your Name</label>
                                        <input type="text" name="name" class="input-white white-text" placeholder="Your name">
                                    </div>
                                    <div class="col s12 m12 l4">
                                        <label for="email" class="white-text">Your Email Address</label>
                                        <input type="email" name="email" class="input-white white-text" placeholder="Your email address">
                                    </div>
                                    <div class="col s12 m12 l4">
                                        <button type="submit" class="btn btn-transparent waves-effect">Send</button>
                                    </div>
                                </form>
                            </div>
                        </div>
