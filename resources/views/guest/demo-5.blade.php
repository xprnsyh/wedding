...
<head>
    ...
    <title>Hoofey - Template Wedding Chocolate</title>
...
<body>
                    ...
                    <div class="col s12 m12 l8" id="detail-container">
                        <div class="opening-detail">
                            <div class="col s12 m4 l4">
                                ...
                                <h4 class="chocolate-text">Adam</h4>
                                <p class="chocolate-text">Putra dari Bapak Rully Wijaya & Ibu Dina Dayani</p>
                            </div>
                            <div class="col s12 m4 l4">
                            ...
                            <div class="col s12 m4 l4">
                                ...
                                <h4 class="chocolate-text">Hawa</h4>
                                <p class="chocolate-text">Putri dari Bapak Wijaya & Ibu Agustine</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col s12 m12 l8" id="lokasi-container">
                            <div class="opening-detail">
                                <div class="col s12 m12 l6">
                                    ...
                                    <p class="chocolate-text">Senin, 1 Januari 2021</p>
                                    <p class="chocolate-text">10:00 WIB</p>
                                    <p class="chocolate-text">Jalan Raya Kedawung</p>
                                    <p class="chocolate-text">Cirebon</p>
                                </div>
                                <div class="col s12 m12 l6">
                    ...
                    <div class="row">
                        <div class="col s12 m12">
                            <div class="opening-detail" id="btn-lokasi">
                                <a href="#" class="btn-choco">Lihat Lokasi</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="section chocolate" id="slider-gallery">
                        ...
                        <div class="attend">
                            <div class="row">
                                <form action="#">
                                    ...
                                    <div class="col s12 m12 l4">
                                        <button type="submit" class="btn btn-choco waves-effect">Send</button>
                                    </div>
                                </form>
                            </div>
                        </div>
