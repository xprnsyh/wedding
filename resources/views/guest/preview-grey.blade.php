...
<body>
                    ...
                    <div class="col s12 m12 l12">
                        <div class="opening-detail">
                            <div class="row">
                                ...
                                <div class="col s12 m4 l2">
                                    <h4 class="grey-text text-lighten-1">{{$event->nama_lengkap_mempelai_wanita}}</h4>
                                ...
                                <div class="col s12 m4 l2">
                                    <h4 class="grey-text text-lighten-1">{{$event->nama_lengkap_mempelai_pria}}</h4>
    ...
    <div class="section grey darken-3 valign-wrapper" style="padding:0;">
        <div class="row valign">
            <div class="col s12 m12 l12">
                <div class="row">
                        ...
                        <div class="attend">
                            <div class="row">
                                ...
                                @csrf
                                    ...
                                    <div class="col s12 m12 l4">
                                        <button type="submit" class="btn btn-transparent waves-effect">I am Attending</button>
                                    </div>
                                </form>
                            </div>
                        </div>
