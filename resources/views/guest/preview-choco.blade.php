...
<body>
    <div class="section header" style="padding-bottom:0;">
        ...
        <div style="height: 150px; overflow: hidden;">
            <svg viewBox="0 0 500 150" preserveAspectRatio="none" style="height: 100%; width: 100%;">
                ...
                <path d="M-8.74,84.38 C149.99,150.00 381.77,151.47 511.57,85.36 L500.00,150.00 L0.00,150.00 Z" style="stroke: none; fill: #72564f;"></path>
            </svg>
        </div>
    </div>

    <div class="section chocolate valign-wrapper">
        <div class="row valign">
                    ...
                    <div class="col s12 m12 l8" id="detail-container">
                        <div class="opening-detail">
                            <div class="col s12 m4 l4">
                                ...
                                <h4 class="chocolate-text">{{$event->nama_lengkap_mempelai_wanita}}</h4>
                                <p class="chocolate-text">{{$event->bio_mempelai_wanita}}</p>
                                @else
                                <h4 class="chocolate-text" style="margin: 20vh 0 0;">{{$event->nama_lengkap_mempelai_wanita}}</h4>
                                <p class="chocolate-text">{{$event->bio_mempelai_wanita}}</p>
                                @endif
                            </div>
                            <div class="col s12 m4 l4">
                                <h4 class="chocolate-text" id="and">&</h4>
                            </div>
                            <div class="col s12 m4 l4">
                                @if($event->avatar_pria != null)
                                <img src="{{asset($event->avatar_pria)}}" alt="fotomempelai" class="image-mempelai">
                                <h4 class="chocolate-text">{{$event->nama_lengkap_mempelai_pria}}</h4>
                                <p class="chocolate-text">{{$event->bio_mempelai_pria}}</p>
                                @else
                                <h4 class="chocolate-text" style="margin: 20vh 0 0;">{{$event->nama_lengkap_mempelai_pria}}</h4>
                                <p class="chocolate-text">{{$event->bio_mempelai_pria}}</p>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="col s12 m12 l8" id="lokasi-container">
                        <div class="opening-detail">
                            <div class="col s12 m12 l6">
                                <h6 class="chocolate-text">Akad Nikah</h6>
                                <p class="chocolate-text">{{ \Carbon\Carbon::parse($event->tanggal_ijab)->dayName}}, {{ \Carbon\Carbon::parse($event->tanggal_ijab)->format('d M Y')}}</p>
                                <p class="chocolate-text">{{ \Carbon\Carbon::parse($event->jam_mulai_ijab)->format('H:i')}} WIB</p>
                                <p class="chocolate-text">{{$event->lokasi_ijab}}</p>
                            </div>
                            <div class="col s12 m12 l6">
                                <h6 class="chocolate-text">Resepsi Pernikahan</h6>
                                <p class="chocolate-text">{{ \Carbon\Carbon::parse($event->tanggal_resepsi)->dayName}}, {{ \Carbon\Carbon::parse($event->tanggal_resepsi)->format('d M Y')}}</p>
                                <p class="chocolate-text">{{ \Carbon\Carbon::parse($event->jam_mulai_resepsi)->format('H:i')}} WIB</p>
                                <p class="chocolate-text">{{$event->lokasi_resepsi}}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col s12 m12">
                            <div class="opening-detail" id="btn-lokasi">
                                <a href="{!!$event->gm_ijab!!}" class="btn-choco">Lihat Lokasi</a>
                            </div>
                        </div>
                    </div>
                    @endif
    ...
    <div class="section chocolate valign-wrapper" style="padding:0;">
        <div class="row valign">
            <div class="col s12 m12 l12">
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                @csrf
                                    <div class="col s12 m12 l4">
                                        <label for="name" class="chocolate-text">Your Name</label>
                                        <input type="text" name="name" class="input-choco" placeholder="Your name">
                                    </div>
                                    <div class="col s12 m12 l4">
                                        <label for="email" class="chocolate-text">Your Email Address</label>
                                        <input type="email" name="email" class="input-choco" placeholder="Your email address">
                                    </div>
                                    <div class="col s12 m12 l4">
                                        <button type="submit" class="btn btn-choco waves-effect">I am Attending</button>
                                    </div>
                                </form>
                            </div>
                        </div>
