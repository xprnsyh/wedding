...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="{{ route('admin.create.event') }}" class="btn btn-linear-primary mb-4">
                                ...
                                <tbody>
                                    @foreach ($events as $event)
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                    href="{{ route('admin.edit.event', ['invoice' => $event->order->invoice]) }}">
                                                    {{ $event->order->invoice }}
                                                </a>
                                            </td>
                                            <td>
                                                <!-- <a  href="/s/{{ $event->id }}"
                                                    target="_blank" title="Monitor"><iconify-icon icon="lucide:monitor-play"></iconify-icon></a> -->
                                            ...
                                            <td>
                                                ...
                                                @endif
                                                <!-- <a href="{{ route('list.guestbook', $event->slug) }}" target="_blank" title="Meja tamu"><iconify-icon icon="guidance:information-desk-people"></iconify-icon></a> -->
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.delete.event', ['id' => $event->id]) }}"
    ...
    {{-- <div class="container-fluid">
        ...
        <div class="page-title">
            <h3 style="font-weight: 500;">Events Management</h3>
        </div>
        <!-- END PAGE TITLE -->
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="info-box bg-blue">
                    <div class="content">
                        <div class="text font-bold">
                            <p>Jumlah Total Event Hari Ini</p>
                        </div>
                        <div class="number">{{ $events->where('tanggal_ijab', \Carbon\Carbon::now())->count() }}
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="header">
                        <div class="row clearfix">
                            <div class="col-xs-12 col-sm-6">
                                <h4 style="font-weight:500; font-size:20px;">Events</h4>
                            </div>
                            <div class="col-xs-12 col-sm-6 align-right">

                                <a href="{{ route('admin.create.event') }}" class="btn btn-info waves-effect"
                                ...
                                <tbody>
                                    @foreach ($events as $event)
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                    href="{{ route('admin.show.event', ['invoice' => $event->order->invoice]) }}">
                                                    {{ $event->order->invoice }}
                                                </a>
                                            </td>
                                            <td>
