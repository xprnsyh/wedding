                        ...
                        @foreach ($event->invite as $key => $guest)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="action-icon send send_invitation_link btn" title="send-link"
                                        data-id="{{ route('see.event', ['slug' => $event->slug]) }}?invite={{ $guest->rand_code }}:"
                                        data-target="_blank" data-name="{{$guest->name}}">
