                    ...
                    <form action="{{ route('admin.update.event', ['id' => $event->id]) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select id="order_id" name="order_id" class="form-control show-tick" disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="code_event" id="code_event"
                                        value="{{ $event->code_event }}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                            ...
                                            @if (isset($event->avatar_pria))
                                                <div class="img-event-wrapper">
                                                    ...
                                                    <img src="{{ asset('admin/assets/images/pria/' . $event->order->invoice . '/' . $event->avatar_pria) }}"
                                                        ...
                                                        style="border-radius: 10px" id="show-pria">
                                                </div>
                                            @else
                                    ...
                                    <div class="col-lg-9 col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_lengkap_mempelai_pria"
                                                value="{{ $event->nama_lengkap_mempelai_pria }}" class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_panggilan_mempelai_pria"
                                                value="{{ $event->nama_panggilan_mempelai_pria }}" class="form-control"
                                                placeholder="Name">
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="row">
                                            ...
                                            @if (isset($event->avatar_wanita))
                                                <div class="img-event-wrapper">
                                                    ...
                                                    <img src="{{ asset('admin/assets/images/wanita/' . $event->order->invoice . '/' . $event->avatar_wanita) }}"
                                                        alt="Foto Mempelai Wanita" width="100%" class="event-avatar"
                                                        style="border-radius: 10px" id="photo_wanita">
                                                </div>
                                            @else
                                                <img src="https://cdn0.iconfinder.com/data/icons/social-media-network-4/48/male_avatar-512.png"
                                    ...
                                    <div class="col-lg-9 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="avatar_wanita" id="avatar_wanita"
                                                class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_lengkap_mempelai_wanita"
                                                value="{{ $event->nama_lengkap_mempelai_wanita }}" class="form-control"
                                                placeholder="Full Name">
                                        </div>
                                        <div class="form-group">
                                            <label for="NamaPanggilanPria">Nama Panggilan Mempelai
                                            ...
                                            <input type="text" name="nama_panggilan_mempelai_wanita"
                                                value="{{ $event->nama_panggilan_mempelai_wanita }}" class="form-control"
                                                placeholder="Bio">
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="TanggalIjab">Tanggal Akad/Janji Pernikahan</label>
                                    <input type="date" name="tanggal_ijab" id="tanggal_ijab" class="form-control"
                                        value="{{ $event->tanggal_ijab }}">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="TanggalIjab">Jam Mulai Akad/Janji Pernikahan</label>
                                    <input type="time" name="jam_mulai_ijab" id="jam_mulai_ijab" class="form-control"
                                        value="{{ $event->jam_mulai_ijab }}">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="TanggalIjab">Jam Selesai Akad/Janji Pernikahan</label>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="TanggalIjab">Lokasi Akad/Janji Pernikahan</label>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <div class="group">
                                            ...
                                            <i class="fa fa-info-circle fa-pull-right" aria-hidden="true"
                                                {{ Popper::trigger(true, true, false)->pop('Buka Youtube klik videonya, klik bagikan/share, klik salin link/ copy link.') }}></i>
                                        </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <div class="group">
                                        ...
                                        <i class="fa fa-info-circle fa-pull-right" aria-hidden="true"
                                            {{ Popper::trigger(true, true, false)->pop('Buka Google Maps tandai tempat acaranya, klik bagikan/share, klik salin link/ copy link.') }}></i>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <div class="group">
                                            ...
                                            <i class="fa fa-info-circle fa-pull-right" aria-hidden="true"
                                                {{ Popper::trigger(true, true, false)->pop('Pilihan ini digunakan untuk menentukan tampilan monitor.') }}></i>
                                        </div>
                                        <select id="monitor" name="monitor" class="form-control show-tick">
                                            <option value="" disabled selected>Pilih Opsi</option>
                                            <option value="Photo" {{ $event->monitor == 'Photo' ? 'selected' : '' }}>
                                                Photo</option>
                                            <option value="Video" {{ $event->monitor == 'Video' ? 'selected' : '' }}>
                                                Video</option>
                                        </select>
