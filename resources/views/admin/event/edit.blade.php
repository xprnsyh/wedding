        ...
        <div class="col-12 p-0">
            <div aria-label="breadcrumb" class="breadcrumb-wrapper">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="#">Edit</a>
                    </li>
                </ol>
            </div>
        </div>
        ...
        <section class="events">
            <div class="tab-events d-flex justify-content-between align-items-center">
                ...
                <ul style="list-style: none">
                    <li>
                        <div class="btn-group">
                            <a href="{{ route('admin.event.build', $event->slug) }}" class="btn btn-primary"
                                target="_blank">
            ...
            <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="order_id" class="form-control" disabled>
                                                        <option value="">
                                                            -= Select Invoice =-
                                                        </option>
                                            ...
                                            <div class="col-sm-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="code_event"
                                                        id="code_event" value="{{ $event->code_event }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="NamaPanggilanWanita">Nama Lengkap Mempelai
                                                                Wanita</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="NamaPanggilanWanita">Bio Mempelai Wanita</label>
                ...
                <div class="tab-pane fade photos" id="pills-photos" role="tabpanel" aria-labelledby="pills-photos-tab">
                    <form action="{{ route('admin.store.photo', ['id' => $event->id]) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                                        ...
                                        <tbody>
                                            @foreach ($data_guestbook as $key => $guest)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.delete.ucapan', ['id' => $guest->id]) }}"
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal fade" id="editAngpao{{ $angpao->id }}"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <form
                                                                    action="{{ route('admin.update.angpao', ['id' => $angpao->id]) }}"
                                                                    method="post">
                                                                    @csrf
                                                        ...
                                                        <a href="{{ route('admin.delete.angpao', ['id' => $angpao->id]) }}"
                                                            class="action-icon object-group">
                                                            <i class="fa fa-trash"></i>
                                                        </a>
...
@section('add-js')
    ...
    <script>
        ...
        $('#editButtonInvitation').click(function() {
            ...
            const full_text = "Assalamu'alaikum Wr. Wb \n" +
            ...
            $('#invitation_text_form').html(full_text);
            $('#btn_copy').removeAttr('disabled');
            invitationText = $('#invitation_text_form').val();
        ...
        $('#btn_copy').click(function() {
            if ($(this).attr('disabled')) {
                alert('Klik tombol edit terlebih dahulu');
            }
            const nama_tamu = document.getElementById('nama_tamu').value;
            /* Get the text field */
            const copyText = document.getElementById('link_invitation');
    ...
    <script>
        ...
        $(function() {
            ...
            $('#nama_tamu').keyup(function() {
                ...
                var link = "{{ route('see.event', $event->slug) }}";
                var link_complete = link + '?invite=' + encodeURI(nama_tamu);
                document.getElementById('link_invitation').value = link_complete;
            });
            ...
            $('#btn_copy').click(function() {
                var nama_tamu = document.getElementById('nama_tamu').value;
                /* Get the text field */
                var copyText = document.getElementById('link_invitation');
                ...
                var full_text = "Assalamu'alaikum Wr. Wb \n" +
                    "Bismillahirrahmanirrahim. \n" +
                    "Dear " + nama_tamu + ", \n" +
                    "Dengan memohon Rahmat dan Ridho Allah SWT. Tanpa mengurangi rasa hormat, Kami bermaksud ingin memberitahukan kepada Bapak/Ibu/Saudara/i dan Rekan-Rekan bahwa Kami akan melangsungkan Pernikahan yang Insya Allah akan dilaksanakan pada:" +
                    "\n🗓️ Hari, tanggal: {{ \Carbon\Carbon::parse($event->tanggal_ijab)->dayName }}, {{ \Carbon\Carbon::parse($event->tanggal_ijab)->format('d M Y') }}" +
                    "\n\nOfficial Web Wedding Invitation : \n✉️" + copyText.value + "\n\n" +
                    "Dikarenakan situasi pandemi Covid-19 yang belum membaik, Kami memutuskan untuk merayakannya hanya bersama keluarga dan beberapa teman-teman dekat." +
                    "\n\nKami memohon maaf tidak dapat mengundang Bapak/Ibu/Saudara/i dan Rekan-Rekan sekalian menjadi bagian dihari bahagia Kami. Dan yang paling penting tetap jaga kesehatan." +
                    "\n\nTerima kasih atas pengertiannya dan mohon doa restu dari Bapak/Ibu/Saudara/i dan Rekan-Rekan sekalian." +
                    "\n\nWassalamu'alaikum Wr.Wb." +
                    "\n\nKami yang berbahagia,\n" +
                    "{{ $event->nama_panggilan_mempelai_wanita }} & {{ $event->nama_panggilan_mempelai_pria }}";
