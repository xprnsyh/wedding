        ...
        <div class="col-12 p-0">
            <div aria-label="breadcrumb" class="breadcrumb-wrapper">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a
                            href="{{ route('admin.index.list_bank') }}">List Bank</a></li>
                </ol>
            </div>
        </div>
    </div>
                                ...
                                <tbody>
                                    @foreach ($list_bank as $index => $bank)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($bank->logo_url)
                                                <img src="{{ asset('admin/assets/images/list_banks/'. $bank->logo_url) }}"
                                            ...
                                            <td>
                                                @if($bank->id)
                                                    ...
                                                    <a href="{{ route('admin.delete.list_bank', ['id' => $bank->id]) }}"
    ...
    <div class="modal fade" id="addBankModal" tabindex="-1" role="dialog" aria-labelledby="addBankModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.store.list_bank') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="logo_url">Logo Bank</label>
                            <input type="file" class="form-control" name="logo_url" placeholder="type here....">
                        </div>
                    </div>
                ...
                <form action="" method="post" id="form-edit" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group text-center mt-0">
                            <img id="logo_bank" src="" style="width: 100px;">
                        </div>
                        <div class="form-group">
                            <label for="name">Name</label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit-bank').click(function() {
                ...
                link = "/admin/list-bank-angpao/"+$id+"/edit"
                $.ajax({ //create an ajax request to display.php
                    ...
                    success: function(data) {
                        const img = "/admin/assets/images/list_banks/" + data.logo_url;
                        const urledit = "/list-bank-angpao/"+ $id +"/update";
                        $("#name").val(data.name);
