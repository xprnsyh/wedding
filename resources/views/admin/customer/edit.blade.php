...
@section('content')
    <div class="content">
        <section class="users">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.update.customer', ['id' => $customer->id]) }}" method="post"
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <textarea name="address" id="address" cols="30" rows="14"
                                                class="form-control no-resize"
                                                placeholder="Your address....">{{ old('address') ? old('address') : $customer->address }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select name="province_id" id="province_id" class="form-control">
                                                @foreach ($provinces as $province)
                                                    <option value="{{ $province->id }}"
                                                        {{ old('province_id') == $province->id ? 'selected' : false }}>
