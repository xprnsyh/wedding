    ...
    <div class="content">
        @if ($failed_newsletter->count() > 0)
            <div class="alert alert-danger">
                <span class="text text-sm"> <span class="text-danger">There's an email haven't sent. </span><a
                        href="{{ route('admin.queue.store.newsletter') }}">resend email!</a></span>
            </div>
        @endif
                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h1 class="form-title float-left" style="vertical-align: -3px">
                                        Newsletter
                                    </h1>
                                    <div class="float-right">
                                        <a href="#" class="btn btn-outline-grey mr-2" style="margin-top: -24px"
                                            data-toggle="modal" data-target="#addGroupModal">Add Group</a>
                                        <a href="{{ route('admin.create.newsletter') }}"
                                ...
                                <tbody>
                                    @foreach ($newsletters as $i => $newsletter)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.show.newsletter', ['id' => $newsletter->id]) }}"
                                                    class="btn btn-primary px-3 py-1">Show</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                    ...
                    <div class="header">
                        <div class="row clearfix">
                            <div class="col-xs-12 col-sm-6">
                                <h4 style="font-weight:500; font-size:20px;">Newsletter</h4>
                            </div>
                            <div class="col-xs-12 col-sm-6 align-right">
                                <button type="button" class="btn btn-outline-info waves-effect"
                                    style="padding: 8px 16px; margin-right: 10px !important;" data-toggle="modal"
                                    data-target="#tambahDataGroup">
                                    <i class="material-icons">add</i> Add Group
                                </button>
                                <a href="{{ route('admin.create.newsletter') }}" class="btn btn-info waves-effect"
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 ">
                                <div class="form-group form-bank" id="wrapper-group-contact">
                                    ...
                                    <input type="text" class="form-control" id="group_name" name="group_name"
                                        placeholder="type here...." value="{{ old('group_name') ?? old('group_name') }}">
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addGroupModalLabel">Newsletter</h5>
                ...
                <form action="{{ route('admin.store.groupcontact') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group" id="wrapper-group-contact">
                            <label for="name">Group Name</label>
                            <input type="text" class="form-control" id="group_name" name="group_name"
                                placeholder="type here...." value="{{ old('group_name') ?? old('group_name') }}">
                        </div>
...
@section('add-js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('input[name="contact"]').amsifySuggestags({
                type: 'bootstrap',
            });
