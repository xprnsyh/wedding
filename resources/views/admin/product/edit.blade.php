        ...
        <div class="col-12 p-0">
            <div aria-label="breadcrumb" class="breadcrumb-wrapper">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a
                            href="{{ route('admin.edit.product', ['id' => $product->id]) }}">Edit</a></li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 mt-3 py-5e">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr />
                            <form action="{{ route('admin.update.product', ['id' => $product->id]) }}" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="category_id" class="form-control">
                                                ...
                                                @foreach ($categories as $row)
                                                    <option value="{{ $row->id }}"
                                                        {{ $product->category_id == $row->id ? 'selected' : false }}>
                                                        {{ $row->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    @if ($product->image != null)
                                        <div class="col-12 text-center mt-2">
                                            <img src="{{ asset('admin/assets/images/products/' . $product->image) }}"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="editor1" rows="10"
                                                cols="80"> {{ old('description') ? old('description') : $product->description }}
                                                                                                                                                                                                                        </textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-line">
                                            ...
                                            <select name="category_id" class="form-control show-tick">
                                                @foreach ($categories as $row)
                                                    <option value="{{ $row->id }}"
                                                        {{ (old('category_id') == $row->id ? 'selected' : $product->category_id == $row->id) ? 'selected' : '' }}>
                                                        {{ $row->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-line">
                                            <b>Price</b>
                                            <input type="text" name="price" class="form-control money-dollar"
                                                value="{{ old('price') ? old('price') : $product->price }}">
