        ...
        <div class="col-12 p-0">
            <div aria-label="breadcrumb" class="breadcrumb-wrapper">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a
                            href="{{ route('admin.list.category') }}">Kategori</a></li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="/admin/newevents.html" class="btn btn-linear-primary mb-4" data-toggle="modal"
                            ...
                            <table id="datatables" class="table-scroll display dt-responsive table table-hover">
                                ...
                                <tbody>
                                    @foreach ($categories as $i => $category)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="action-icon edit" data-toggle="modal"
                                                    data-target="#editDataCategory{{ $category->id }}">
                                        ...
                                        <div class="modal fade" id="editDataCategory{{ $category->id }}" tabindex="-1"
                ...
                <div class="header">
                    <div class="row clearfix">
                        <div class="col-xs-12 col-sm-6">
                            <h4 style="font-weight:500; font-size:20px;">Categories</h4>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-pink btn-circle waves-effect waves-circle waves-float" data-toggle="modal" data-target="#editDataRole{{$category->id}}">
                                            <i class="material-icons">edit</i>
                                        </button>
                                        <a href="{{route('admin.delete.category', [ 'id' => $category->id ])}}" class="btn btn-pink btn-circle waves-effect waves-circle waves-float">
                                            <i class="material-icons">delete</i>
                                        </a>
                                    </td>
                                    <div class="modal fade" id="editDataRole{{$category->id}}" tabindex="-1" role="dialog" style="display: none;">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header header">
