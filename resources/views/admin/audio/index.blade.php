        ...
        <div class="col-12 p-0">
            <div aria-label="breadcrumb" class="breadcrumb-wrapper">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a
                            href="{{ route('admin.list.audio') }}">Audio</a></li>
                </ol>
            </div>
        </div>
    </div>
...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="datatables" class="table-scroll display dt-responsive table table-hover">
                                ...
                                <tbody>
                                    @foreach ($data_audio as $i => $audio)
                                        <tr>
                                            <td>{{ ++$i }}</td>
                                            <td>{{ $audio->name }}</td>
                                            <td>
                                                <audio controls>
                                                    <source src="{{ asset('admin/assets/audio/' . $audio->path) }}"
                                                        type="audio/mpeg">
                                                </audio>
                                            </td>
                                            <td>
                                                <a href="{{ route('admin.delete.audio', ['id' => $audio->id]) }}"
    ...
    <div class="modal fade" id="addAudioModal" tabindex="-1" role="dialog" style="display: none;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header header">
                    <h5 class="modal-title">New audio</h5>
                </div>
                <form action="{{ route('admin.create.audio') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Audio</label>
                            <input type="file" name="file_audio" id="file_audio" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="header">
                        <div class="row clearfix">
                            <div class="col-xs-12 col-sm-6">
                                <h4 style="font-weight:500; font-size:20px;">Audio</h4>
                            </div>
                            <div class="col-xs-12 col-sm-6 align-right">
                                <button type="button" class="btn btn-info waves-effect" style="padding: 8px 16px;"
                                    data-toggle="modal" data-target="#tambahDataRole">
                                    <i class="material-icons">add</i> <span>New Audio</span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="tambahDataRole" tabindex="-1" role="dialog" style="display: none;">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('admin.create.audio') }}" method="post"
                                    ...
                                    <div class="modal-body">
                                        <div class="row clearfix">
                                            <div class="col-sm-12 col-md-12 col-lg-12 ">
                                                ...
                                                <div class="form-group">
                                                    <label>Audio</label>
                                                    <input type="file" name="file_audio" id="file_audio"
