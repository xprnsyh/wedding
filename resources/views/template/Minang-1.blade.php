...
<head>
    ...
    <!--<meta name="title" content="Reza &amp; Dita - Katsudoto.id">-->
    <!--<title>Hoofey - Wedding of {{ $event->nama_panggilan_mempelai_wanita ?? 'Hawa' }}  &amp; {{ $event->nama_panggilan_mempelai_pria ?? 'Adam'}}-->
    <!--</title>-->
    ...
    <!-- <meta property="og:image" itemprop="image" content="{{ asset('admin/assets/images/events/' . $event->order->invoice . '/' . $event->logo_req) }}">
    <meta property="og:image:type" content="image/png" />
    <meta property="og:image:width" content="300" />
    <meta property="og:image:height" content="300" />
     <meta property="og:title" content="Hoofey - Wedding of  {{ $event->nama_panggilan_mempelai_wanita }} & {{ $event->nama_panggilan_mempelai_pria }}" />
    <meta property="og:description" content="{{ \Carbon\Carbon::parse($event->tanggal_resepsi)->format('M d Y') }}, {{ $event->lokasi_resepsi }}">
                ...
                <div class="details">
                    <div class="cover-logo-wrap" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="900">
                        ...
                        <h1 class="prime-title" data-aos="fade-up" data-aos-duration="1200"
                            data-aos-delay="200">{{ $event->nama_panggilan_mempelai_wanita ?? 'Hawa'}}</h1>
                        <h1 class="prime-title" data-aos="fade-up" data-aos-duration="1200"
                            data-aos-delay="200"> & </h1>
                        <h1 class="prime-title" data-aos="fade-up" data-aos-duration="1200"
                            data-aos-delay="200">{{ $event->nama_panggilan_mempelai_pria ?? 'Adam'}}</h1>
                    </div>
                    @isset($invite)
                        @if ($invite->name)
                ...
                <section class="cover" id="home">
                    <div class="cover-inner">
                        ...
                        <div class="cover-foot">
                            <h1 class="prime-title" data-aos="fade-up" data-aos-duration="1200"
                                data-aos-delay="200">{{ $event->nama_panggilan_mempelai_wanita ?? 'Hawa' }} &
                        ...
                        <div class="couple-body bride-first show-picture">
                            ...
                            <div class="couple-info bride">
                                ...
                                <div class="couple-details">
                                    ...
                                    <p class="couple-parents" data-aos="fade-up" data-aos-duration="1000"
                                        data-aos-delay="200" style="text-align: center;">
                                            @if(isset($invite->is_special))
                                                Putri Pertama dari Bpk Awang Setiawan & Ibu Yulismawati
                                            @else
                                                {!! nl2br(e($event->bio_mempelai_wanita ?? '')) !!}
                                            @endif
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="agenda-body">
                            ...
                            <div class="event-item" data-aos="fade-up" data-aos-duration="1200">
                                ...
                                <div class="activity-wrap ">
                                    ...
                                    <div class="event-head">
                                        <h1 class="event-day" data-aos="fade-up" data-aos-duration="1000">
                                            {{ \Carbon\Carbon::parse($event->tanggal_resepsi)->formatLocalized('%A') }}
                                        </h1>
                                        <p class="event-date" data-aos="fade-up" data-aos-duration="1000">
