    ...
    @role('admin')
        <div class="content p-card">
                        ...
                        <div class="card __info">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-7">
                                        <h4>Order Pending</h4>
                                        <p class="big-number">{{ $orders ? $orders->count() : 0 }}</p>
                                    </div>
                                    <div class="col-5">
                                        <div class="icon-card wrapper d-flex align-items-center justify-content-end"
                                            style="height: 100%">
            ...
            <section class="invitation">
                ...
                @if ($invitations_foradmin->count() > 0)

                    <div class="row">
                        @foreach ($invitations_foradmin as $invitation)

                            <div class="col-lg-4 col-md-6 col-sm-6 mt-3">
                                <div class="card">
                                    <div class="card-img-top text-center"
                                        style="background-size: cover; background-repeat: no-repeat; background-position: center; background: -webkit-gradient(linear, left top, left bottom, color-stop(11%, rgba(0, 0, 0, 0)), to(#000000)), url('{{ asset('admin/assets/images/events/' . $invitation->order->invoice . '/' . $invitation->logo_req) }}'), #ffffff">
                                        <p>The Wedding of</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <div class="img-barcode-wrapper">
                                                    {!! QrCode::size(250)->generate($invitation->code_event) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card __info">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-7">
                                        <h4>Acara Kamu</h4>
                                        <p class="big-number">{{ $events ? $events->count() : 0 }}</p>
                                    </div>
                                    <div class="col-5">
                                        <div class="icon-card wrapper d-flex align-items-center justify-content-end"
                                            style="height: 100%">
                        ...
                        <div class="card __info">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-7">
                                        <h4>Order Pending</h4>
                                        <p class="big-number">{{ $order_pending ? $order_pending->count() : 0 }}</p>
                                    </div>
                                    <div class="col-5">
                                        <div class="icon-card wrapper d-flex align-items-center justify-content-end"
                                            style="height: 100%">
